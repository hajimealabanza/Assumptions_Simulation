...
## true parameters
set.seed(321)
n <- 50        # sample size, n > 30 so dont need to worry about normality of errors 
reps <- 10000  # number of simulations 
b0 <- 300      # true intercept for house price 
...
# Note: these are imperfect simulations. While it is unlikely, it could result in a simulated home that has 
# either negative square footage or age. However, the results will still make sense.
